...
### Methods
  ...
  In order to implement the FEM, we began with a rectangular mesh generating code written in Matlab.$^7$ From here, we modified the code to fit our model. This involved changing ____________. Finally, we translated our modified Matlab code into C. 
