...
In the current work, we try to model solidification of a one component system with phase field method. Our phase filed variable $\phi$ assumes values between 0 and 1, where value 0 represents liquid state and 1 represents solid state. We began with the Ginzburg-Landau entropy functional $S(\phi)$.$^1$ Using variational calculus, we minimize this functional with respect to $\phi$ and arrive at the following partial differential equation: 
