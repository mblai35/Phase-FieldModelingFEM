...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; We present here the Galerkin finite element in 2D. The Galerkin method is an example of a weighted residual method which assumes the same shape functions are used for both the solution and the weights. 
